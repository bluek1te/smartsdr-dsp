...
FT_HANDLE thumbDV_openSerial( FT_DEVICE_LIST_INFO_NODE device )
{
    ...
    thumbDV_writeSerial(handle, "This is an example write to the dongle before set baud rate", 64);
    FT_SetBaudRate(handle, FT_BAUD_460800);
    thumbDV_writeSerial(handle, "This is an example write to the dongle after set baud rate", 64);
